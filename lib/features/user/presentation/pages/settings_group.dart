...
class SettingsGroupPage extends StatefulWidget {
  const SettingsGroupPage({Key? key, required this.groupEntity}) : super(key: key);
...
class _SettingsGroupPageState extends State<SettingsGroupPage> {
  ...
  @override
  void initState() {
nameGroupController.text=widget.groupEntity.name;
descriptionGroupController.text=widget.groupEntity.description;
dropdownValue=widget.groupEntity.isPublic?"Public":"Private";
maxSizeFileController.text=widget.groupEntity.maxAllowedFileSizeInMb;
if(widget.groupEntity.allowedExtensionFileTypes!="null"){
  allowedExtensionFileTypesController.text=widget.groupEntity.allowedExtensionFileTypes!;
}
maxNumFileController.text=widget.groupEntity.maxFilesCount;
maxMemberController.text=widget.groupEntity.maxMemberCount;
                    ...
                    children: [
                      ...
                      SizedBox(
                          ...
                          child: BlocConsumer<GroupsBloc, GroupsState>(
                            listener: (_, state) {
                              if (state is SuccessUpdateCurrentGroupState) {
                                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const HomePage()));
                              }
                              if (state is ErrorUpdateCurrentGroupState) {
                                showError(context, state.message);
                              }
                            },
                            builder: (_, state) {
                              if (state is LoadingUpdateCurrentGroupState) {
                                return const Center(
                              ...
                              return CustomButton(
                                  formKey: formKey,
                                  onTap: () {
                                    BlocProvider.of<GroupsBloc>(context).add(UpdateCurrentGroupEvent(
